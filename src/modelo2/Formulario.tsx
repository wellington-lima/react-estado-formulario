...
export const Formulario = () => {
  ...
  const { formState, onInputChange, onCheckboxChange, onInputRadio } = useFormulario<IData>(dataInicial);
  ...
  return (
    <>
      ...
      <div>
        ...
        <select className="form-select mt-4" name="profissao" value={profissao} onChange={(e) => onInputChange('profissao', e.target.value)}>
